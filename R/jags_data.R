...
jags_data <- function(classification,
  ...
  data.human <- get_human(classification, ...)
  ...
  if(any(categories %in% "animal")) {
    data.animal <- get_animal(classification, ...)
    ...
    cattle_index <- data.animal$lookup_tables$associated_species %>%
      dplyr::filter(associated_species == "cattle") %$% index
    cattle <- data.animal$livestock_dat %>%
      dplyr::filter(associated_species == cattle_index)
    ...
    pig_index <- data.animal$lookup_tables$associated_species %>%
      dplyr::filter(associated_species == "pig") %$% index
    pig <- data.animal$livestock_dat %>%
      dplyr::filter(associated_species == pig_index)
    ...
    chicken_index <- data.animal$lookup_tables$associated_species %>%
      dplyr::filter(associated_species == "chicken") %$% index
    chicken <- data.animal$livestock_dat %>%
      dplyr::filter(associated_species == chicken_index)
    ...
    cat_index <- data.animal$lookup_tables$associated_species %>%
      dplyr::filter(associated_species == "cat") %$% index
    cat <- data.animal$companion_dat %>%
      dplyr::filter(associated_species == cat_index)
    ...
    dog_index <- data.animal$lookup_tables$associated_species %>%
      dplyr::filter(associated_species == "dog") %$% index
    dog <- data.animal$companion_dat %>%
      dplyr::filter(associated_species == dog_index)
    ...
    fly_index <- data.animal$lookup_tables$associated_species %>%
      dplyr::filter(associated_species == "fly") %$% index
    fly <- data.animal$wild_dat %>%
      dplyr::filter(associated_species == fly_index)
    ...
    turtle_index <- data.animal$lookup_tables$associated_species %>%
      dplyr::filter(associated_species == "turtle") %$% index
    turtle <- data.animal$wild_dat %>%
      dplyr::filter(associated_species == turtle_index)
    ...
    crow_index <- data.animal$lookup_tables$associated_species %>%
      dplyr::filter(associated_species == "crow") %$% index
    crow <- data.animal$wild_dat %>%
      dplyr::filter(associated_species == crow_index)
