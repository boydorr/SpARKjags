model {
  ...
  for(a in 1:antibiotic_classes)
  {
    ...
    { # good bad
      ...
      {
        ac.effect[a,b,c] <- antibiotic.class.effect[a,b] + clin.effect[c]
  ...
  #monitor# full.pd, dic, deviance, a.prob, ac.prob, a.gp.prob, a.v.prob, a.o.prob, prob.of.bad.hosp, prob.of.bad.gp, prob.of.bad.vol, prob.of.bad.out, bad.p, bad.gp, bad.v, bad.o, intercept, sd.class, odds.c
}
