model {
  ...
  for(a in 1:antibiotic_classes)
  {
    for(b in 1:2)
    {
      for(s in 1:N_sample_month)
      {
        logit(asm.prob[a,b,s]) <- antibiotic.class.effect[a,b] +
          samplemonth.effect[s]
      }
    }
  }
  ...
  #monitor# full.pd, dic, deviance, a.prob, prob.of.bad.hosp, prob.of.bad.gp, prob.of.bad.vol, prob.of.bad.out, bad.p, bad.gp, bad.v, bad.o, intercept, sd.class, sd.samplemonth
}
