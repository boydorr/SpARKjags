model {
  ...
  #monitor# full.pd, dic, deviance, a.prob, prob.of.bad.hosp, prob.of.bad.gp, prob.of.bad.vol, prob.of.bad.out, prob.of.bad.companion, bad.p, bad.gp, bad.v, bad.o, bad.companion, intercept, sd.class
}
