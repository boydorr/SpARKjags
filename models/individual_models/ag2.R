model {
  ...
  {
    h_resist[p] ~ dbern(agegroup.prob[age_group2[h_sample_GUID[p]]])
  }

  for (gp in 1:N_gp)
  {
    gp_resist[gp] ~ dbern(agegroup.prob[age_group2[gp_sample_GUID[gp]]])
  }

  for (v in 1:N_volunteers)
  {
    v_resist[v] ~ dbern(agegroup.prob[age_group2[v_sample_GUID[v]]])
  }

  for (o in 1:N_outpatients)
  {
    o_resist[o] ~ dbern(agegroup.prob[age_group2[o_sample_GUID[o]]])
  }
  ...
  {
    agegroup.effect[a] ~ dnorm(intercept, tau.agegroup)
