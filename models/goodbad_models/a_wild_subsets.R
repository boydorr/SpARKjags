model {
  ...
  #monitor# full.pd, dic, deviance, a.prob, prob.of.bad.hosp, prob.of.bad.gp, prob.of.bad.vol, prob.of.bad.out, prob.of.bad.fly, prob.of.bad.turtle, prob.of.bad.crow, bad.p, bad.gp, bad.v, bad.o, bad.fly, bad.turtle, bad.crow, intercept, sd.class
}
