model {
  ...
  #monitor# full.pd, dic, deviance, a.prob, prob.of.bad.hosp, prob.of.bad.gp, prob.of.bad.vol, prob.of.bad.out, prob.of.bad.cattle, bad.p, bad.gp, bad.v, bad.o, bad.cattle, intercept, sd.class
}
